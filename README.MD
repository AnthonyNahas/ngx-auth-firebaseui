...
| goBackURL            | Input()  | string  | - | the url to use for the router after the  authentication
| messageOnAuthSuccess | Input()  | string  | see the code -> | the message of the snackbar when the authentication process was succussful
