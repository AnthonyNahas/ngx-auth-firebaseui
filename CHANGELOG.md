...
* fix(project): upgraded angular-eslint/schematics (d02e447)
* fix(project): upgraded to angular flexlayout (fb7d0b6)
* fix(project): upgraded to angular universal (29cfed9)
* fix(project): upgraded to angular fire to v7.4.1 (e533bfa)
* fix(project): upgraded to angular material to v14 (3da2312)
* fix(project): upgraded to angular v14 (306ff9a)
* chore(lib): release v6.0.0 (cef3cb6)
* feat(lib): updating CHANGELOG.md for v6.0.0 (802e174)
* feat(lib): updating CHANGELOG.md for v6.0.0 (863fefd)
* fix(project): minor (0e14cf2)
* fix(project): minor (0ff4348)
* fix(project): updated the express engine (ad653f6)
* fix(project): minor (1a15d4d)
* fix(project): minor (4a7a67f)
* chore(lib): release v6.0.0 (289a14d)
* feat(lib): updating CHANGELOG.md for v6.0.0 (dd07dfb)
...
* fix(project): updated express engine (91f7619)
* fix(project): updated the README.MD (704b8a1)
* fix(project): minor (a008aca)
* fix(project): minor (38c1175)
* Merge pull request #638 from 4Cast/master (34f8181)
* Remove personal firebase config (05bd54c)
* Refactor angular.json to use standard ng serve. (8587c42)
* Upgrade to Angular 13 and @angular/fire 7 (4affe98)
* Commit minor changes after clone. (a49fa9e)
* Merge pull request #634 from PatientMapp/chore/update-password-strength-extention (7d3ad04)
* chore: Update @angular-material-extensions/password-strength to v9 (d793935)
* Merge pull request #626 from aviyot/patch-1 (746e4d0)
* Update ngx-auth-firebaseui-providers.md (a29dda6)
...
* **package:** removed unwanted files [#316](https://github.com/anthonynahas/ngx-auth-firebaseui/issues/316) ([6539538](https://github.com/anthonynahas/ngx-auth-firebaseui/commit/653953878d7515bcecf29126a6f28df9c6a6670e))
...
* **package:** added microsoft and yahoo as auth providers [#232](https://github.com/anthonynahas/ngx-auth-firebaseui/issues/232) ([832d81a](https://github.com/anthonynahas/ngx-auth-firebaseui/commit/832d81ad31d2a04a01f1d3e66b41da24e10e6f48))
...
* **package:** updating the display name in firestore fixed on registration [#216](https://github.com/anthonynahas/ngx-auth-firebaseui/issues/216) ([ec129d8](https://github.com/anthonynahas/ngx-auth-firebaseui/commit/ec129d8e67651ebfe0881bf0d82117ae65eef472))
...
* **package:** updated firebase and other dependencies ([076ca43](https://github.com/anthonynahas/ngx-auth-firebaseui/commit/076ca432b9f040e7ff31e709477a58b8e3bfad88))
